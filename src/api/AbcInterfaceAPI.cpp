...
void initAbcInterfaceAPI(py::module &m)
{
    py::class_<PROJECT_NAMESPACE::AbcInterface>(m , "AbcInterface")
        ...
        .def("executeCommand", &PROJECT_NAMESPACE::AbcInterface::executeCommand, "Execute a command")
        .def("set", &PROJECT_NAMESPACE::AbcInterface::set, "Set a parameter")
        .def("unset", &PROJECT_NAMESPACE::AbcInterface::unset, "Unset a parameter")
        .def("undo", &PROJECT_NAMESPACE::AbcInterface::undo, "sets the current network to be the previously saved network")
        .def("read", &PROJECT_NAMESPACE::AbcInterface::read, "Read a file")
        .def("read_library", &PROJECT_NAMESPACE::AbcInterface::read_library, "Read a library file")
        ...
        .def("map", &PROJECT_NAMESPACE::AbcInterface::map, "map action")
